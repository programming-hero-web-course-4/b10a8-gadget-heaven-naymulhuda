...
const Footer = () => {
  return (
    <footer className="footer bg-white text-base-content p-10 mt-96 flex flex-col items-center ">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-center sm:gap-52 gap-8 w-full text-center sm:text-left m-0">
